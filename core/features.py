...
from core.containers import ContainerMixin, DottedDict
from core.parameters import ParameterContainer
...
class FeatureExtractor(object):
    ...
    def extract(self, audio_file, extractor_params=None, storage_paths=None, extractor_name=None):
        ...
        if extractor_params is None:
            extractor_params = self.default_parameters   ######gai le original is {}
